        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests( auth -> {
                    auth.requestMatchers("/login").permitAll()
                            ...
                            .requestMatchers(HttpMethod.GET, "/teste-bem-vindo").hasAuthority(RoleEnum.ADMINISTRADOR.toString())
                            .requestMatchers(HttpMethod.GET, "/usuarios").hasAuthority(RoleEnum.USUARIO.toString())
                            .requestMatchers(HttpMethod.POST, "/usuarios").hasAuthority(RoleEnum.ADMINISTRADOR.toString())
                            .requestMatchers(HttpMethod.POST, "/gerenciador-tarefas").hasAuthority(RoleEnum.ADMINISTRADOR.toString())
                            .anyRequest()
                            .authenticated();
                });
