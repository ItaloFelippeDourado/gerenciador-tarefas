...
public class AutenticacaoService {
    ...
    private static final int EXPIRATION_TOKEN_TIME = 3600000;
    private static final String BEARER = "Bearer ";

    public static void addJWTToken(HttpServletResponse response, Authentication authentication) {
   ...
   public static Authentication obterAutenticacao(HttpServletRequest request) {
